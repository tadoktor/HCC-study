...
HCC_in_TGG_sampleset <- "/OutputFiles/TGG_in_HCC_samples_NC.txt"
...
human_dataset1 <- "/OutputFiles/TGG_HCC_data_absolute_human_NC.txt"
human_dataset2 <- "/OutputFiles/TGG_HCC_data_log2fold_human_NC.txt"

...
######ToxCast
TC_FIM_analysis_genes <- read.table(paste(Root_location,"/OutputFiles/workflow4_Toxcast_HCCchem_assoc_rules_wtDiseaseMap.txt", sep=''), header=TRUE, sep='\t', comment.char='', quote='', na.strings = "",fill=TRUE, strip.white=TRUE, colClasses="character")
...
###Reading in the rules from the FIM analysis
######CTD (TC GENES)
CTDTC_FIM_analysis_genes <- read.table(paste(Root_location,"/OutputFiles/workflow4_TCgenes_in_CTD_HCCchem_assoc_rules_wtDiseaseMap.txt", sep=''), header=TRUE, sep='\t', comment.char='', quote='', na.strings = "",fill=TRUE, strip.white=TRUE, colClasses="character")
##merging the gene annotation data to the rules 
...
###Reading in the rules from the FIM analysis
######CTD ALL
CTDALL_FIM_analysis_genes <- read.table(paste(Root_location,"/OutputFiles/workflow4_allCTD_HCCchem_assoc_rules_wtDiseaseMap.txt", sep=''), header=TRUE, sep='\t', comment.char='', quote='', na.strings = "",fill=TRUE, strip.white=TRUE, colClasses="character")
##merging the gene annotation data to the rules 
...
#write.table(TC_merged_with_GeneID,file=file.path(outDir, "Gene_protein_maps_TC_assoc_results.csv"), sep=',', col.names=TRUE, row.names=FALSE,quote=FALSE)
###CTD (TC GENES)
...
#write.table(CTDTC_merged_with_GeneID,file=file.path(outDir, "Gene_protein_maps_CTDTC_assoc_results.csv"), sep=',', col.names=TRUE, row.names=FALSE,quote=FALSE)
###CTD ALL
...
#write.table(CTDALL_merged_with_GeneID,file=file.path(outDir, "Gene_protein_maps_CTDALL_assoc_results.csv"), sep=',', col.names=TRUE, row.names=FALSE,quote=FALSE)
...
##TOXCAST
TC_Gene_protein <- TC_merged_with_GeneID #read.table(paste(Root_location,"/IntermediateData/Gene_protein_maps_TC_assoc_results.csv", sep=''),header=TRUE, sep=',', comment.char='', quote="", na.strings = "",fill=TRUE, strip.white=TRUE, colClasses="character")
...
write.table(TC_merged_gene_protein_reactome,file=file.path(outDir, "TC_HCCchem_Gene_protein_pathway_maps.txt"), sep='\t', col.names=TRUE, row.names=FALSE,quote=FALSE)
##CTD (TC GENES)
CTDTC_Gene_protein <- CTDTC_merged_with_GeneID #read.table(paste(Root_location,"/IntermediateData/Gene_protein_maps_CTDTC_assoc_results.csv", sep=''),header=TRUE, sep=',', comment.char='', quote="", na.strings = "",fill=TRUE, strip.white=TRUE, colClasses="character")
##merging this with the merged FIM annonation and protein file from above
...
write.table(CTDTC_merged_gene_protein_reactome,file=file.path(outDir, "CTDTC_HCCchem_Gene_protein_pathway_maps.txt"), sep='\t', col.names=TRUE, row.names=FALSE,quote=FALSE)
##CTD ALL
CTDALL_Gene_protein <- CTDALL_merged_with_GeneID #read.table(paste(Root_location,"/IntermediateData/Gene_protein_maps_CTDALL_assoc_results.csv", sep=''),header=TRUE, sep=',', comment.char='', quote="", na.strings = "",fill=TRUE, strip.white=TRUE, colClasses="character")
##merging this with the merged FIM annonation and protein file from above
...
write.table(CTDALL_merged_gene_protein_reactome,file=file.path(outDir, "CTDALL_HCCchem_Gene_protein_pathway_maps.txt"), sep='\t', col.names=TRUE, row.names=FALSE,quote=FALSE)
...
write.table(TC_gene_protein_pathway_disease, file=file.path(outDir2, "TC_HCCchem_Gene_protein_pathway_disease_associations.txt"), sep='\t', col.names=TRUE, row.names=FALSE,quote=FALSE)
...
write.table(CTDTC_gene_protein_pathway_disease, file=file.path(outDir2, "CTDTC_HCCchem_Gene_protein_pathway_disease_associations.txt"), sep='\t', col.names=TRUE, row.names=FALSE,quote=FALSE)
...
write.table(CTDALL_gene_protein_pathway_disease, file=file.path(outDir2, "CTDALL_HCCchem_Gene_protein_pathway_disease_associations.txt"), sep='\t', col.names=TRUE, row.names=FALSE,quote=FALSE)

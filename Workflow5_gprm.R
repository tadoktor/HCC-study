...
######ToxCast
TC_FIM_analysis_genes <- read.table(paste(Root_location,"/OutputFiles/workflow4_Toxcast_assoc_rules_wtDiseaseMap.txt", sep=''), header=TRUE, sep='\t', comment.char='', quote='', na.strings = "",fill=TRUE, strip.white=TRUE, colClasses="character")
...
###Reading in the rules from the FIM analysis
######CTD (TC GENES)
CTDTC_FIM_analysis_genes <- read.table(paste(Root_location,"/OutputFiles/workflow4_TCgenes_in_CTD_assoc_rules_wtDiseaseMap.txt", sep=''), header=TRUE, sep='\t', comment.char='', quote='', na.strings = "",fill=TRUE, strip.white=TRUE, colClasses="character")
##merging the gene annotation data to the rules 
...
###Reading in the rules from the FIM analysis
######CTD ALL
CTDALL_FIM_analysis_genes <- read.table(paste(Root_location,"/OutputFiles/workflow4_allCTD_assoc_rules_wtDiseaseMap.txt", sep=''), header=TRUE, sep='\t', comment.char='', quote='', na.strings = "",fill=TRUE, strip.white=TRUE, colClasses="character")
##merging the gene annotation data to the rules 

...
logfile1<-paste(Root_location,"/OutputFiles/TCgenes_in_CTD_ALLchem_new_standard_lifts",today,".txt",sep="")
logfile2<-paste(Root_location,"/OutputFiles/allCTD_ALLchem_new_standard_lifts",today,".txt",sep="")
logfile3<-paste(Root_location,"/OutputFiles/Toxcast_ALLchem_new_standard_lifts",today,".txt",sep="")
#logfile4<-paste(Root_location,"/OutputFiles/allCTD_ALLchem_new_standard_lifts_newfilter5",today,".txt",sep="")
logfile5<-paste(Root_location,"/OutputFiles/allCTD_ALLchem_new_standard_lifts_newfilter7",today,".txt",sep="")
...
rules5<-arules_function(CTD_all_steatosis,Disease_data_CTD,7,2,logfile5, "CTDALL_merge_ALLchem_merge_newfilter7.txt")

write.table(rules1,paste(Root_location,"/OutputFiles/workflow4_TCgenes_in_CTD_ALLchem_new_stdlifts",today,".txt",sep=''),sep="\t",row.names=F)
write.table(rules2,paste(Root_location,"/OutputFiles/workflow4_allCTD_ALLchem_new_stdlifts",today,".txt",sep=''),sep="\t",row.names=F)
write.table(rules3,paste(Root_location,"/OutputFiles/workflow4_Toxcast_ALLchem_new_stdlifts",today,".txt",sep=''),sep="\t",row.names=F)
#write.table(rules4,paste(Root_location,"/OutputFiles/workflow4_allCTD_ALLchem_new_stdlifts_newfilter5",today,".txt",sep=''),sep="\t",row.names=F)
write.table(rules5,paste(Root_location,"/OutputFiles/workflow4_allCTD_ALLchem_new_stdlifts_newfilter7",today,".txt",sep=''),sep="\t",row.names=F)
...
write.table(Toxcast_Results_wtDisease_map,paste(Root_location,"/OutputFiles/workflow4_Toxcast_ALLchem_new_stdlifts_wtDiseaseMap",today,".txt",sep=''), sep='\t', col.names=TRUE, row.names=FALSE,quote=FALSE)
CTD_TC_Results_wtDisease_map <- unique(merge(rules1, Disease_map, by.x='rhs', by.y='DiseaseID'))
write.table(CTD_TC_Results_wtDisease_map,paste(Root_location,"/OutputFiles/workflow4_TCgenes_in_CTD_ALLchem_new_stdlifts_wtDiseaseMap",today,".txt",sep=''), sep='\t', col.names=TRUE, row.names=FALSE,quote=FALSE)
CTD_all_Results_wtDisease_map <- unique(merge(rules2, Disease_map, by.x='rhs', by.y='DiseaseID'))
write.table(CTD_all_Results_wtDisease_map_newfilter7,paste(Root_location,"/OutputFiles/workflow4_allCTD_ALLchem_new_stdlifts_wtDiseaseMap",today,".txt",sep=''), sep='\t', col.names=TRUE, row.names=FALSE,quote=FALSE)
CTD_all_Results_wtDisease_map_newfilter7 <- unique(merge(rules5, Disease_map, by.x='rhs', by.y='DiseaseID'))
write.table(CTD_all_Results_wtDisease_map_newfilter7,paste(Root_location,"/OutputFiles/workflow4_allCTD_ALLchem_new_stdlifts_newfilter7_wtDiseaseMap",today,".txt",sep=''), sep='\t', col.names=TRUE, row.names=FALSE,quote=FALSE)
